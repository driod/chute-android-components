...
public class PhotoCommentsAdapter extends BaseAdapter {
    private static final String TAG = PhotoCommentsAdapter.class.getSimpleName();
    ...
    public PhotoCommentsAdapter(Context context, final GCCommentCollection collection) {
	super();
