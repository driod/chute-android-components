...
import com.chute.android.comments.adapters.CommentsAdapter;
...
public class CommentsActivity extends Activity {
    ...
    private CommentsActivityIntentWrapper wrapper;
	...
	adapter = new CommentsAdapter(this, new GCCommentCollection());
	listView.setAdapter(adapter);
	titleView = (TextView) findViewById(R.id.titleView);

	wrapper = new CommentsActivityIntentWrapper(getIntent());
	...
	public void onClick(View v) {
	    String comment = CommentsActivity.this.comment.getText().toString();
	    ...
	    GCComments.add(getApplicationContext(), wrapper.getChuteId(), wrapper.getAssetId(),
		    ...
		    .executeAsync();
	    CommentsActivity.this.comment.getText().clear();
	}
    }
